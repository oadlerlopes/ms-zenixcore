package br.com.zenix.core.proxy.utilitaries;
...
public class StringUtils {
	...
	private final static int MOTD_CENTER_PX = 132;
	private final static int INVENTORY_CENTER_PX = 79;

	public static String line = "§m----------------------------------------";
	...
	public static String makeCenteredInventoryTitle(String message) {
		...
		int halvedMessageSize = messagePxSize / 2;
		int toCompensate = INVENTORY_CENTER_PX - halvedMessageSize;
		int spaceLength = DefaultFontInfo.SPACE.getLength() + 1;
		int compensated = 0;
		StringBuilder sb = new StringBuilder();
		while (compensated < toCompensate) {
