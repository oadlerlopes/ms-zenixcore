package br.com.zenix.core.spigot.player.bossbar.nw;
...
/**
 * Bukkit/Spigot/Bungee Java Plugin Maker. EnervateD. All rights reserved.
 */
public class BarUtil {
	...
	public static void teleportBar(Player p) {
		if (dragons.containsKey(p.getName())) {
			Location loc = p.getLocation();
			PacketPlayOutEntityTeleport packet = new PacketPlayOutEntityTeleport(dragons.get(p.getName()).getId(), (int) loc.getX() * 32, (int) (loc.getY() - 100) * 32, (int) loc.getZ() * 32,
